export const titleExpected: string = "Netflix Belarus - Watch TV Shows Online, Watch Movies Online";
export const urlMain: string = "https://www.netflix.com";
export const urlSignIn: string = "/login";
